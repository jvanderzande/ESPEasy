...
boolean Plugin_145(byte function, struct EventStruct *event, String &string)
{
	...
	case PLUGIN_GET_DEVICEVALUENAMES:
	{
		...
		strcpy_P(ExtraTaskSettings.TaskDeviceValueNames[1], PSTR(PLUGIN_VALUENAME3_145));
		break;
	}
	...
	case PLUGIN_ONCE_A_SECOND:
	{
		...
		//if  ((PLUGIN_145_OldState!=PLUGIN_145_State) || ((PLUGIN_145_Timer>0) && (PLUGIN_145_Timer % 600==0)) || (PLUGIN_145_OldLastIDindex!=PLUGIN_145_LastIDindex)|| PLUGIN_145_InitRunned)
		if ((PLUGIN_145_OldState != PLUGIN_145_State) || (PLUGIN_145_OldLastIDindex != PLUGIN_145_LastIDindex) || PLUGIN_145_InitRunned)
		{
...
void PLUGIN_145_Publishdata(struct EventStruct *event)
{
	...
	UserVar[event->BaseVarIndex + 1] = PLUGIN_145_LastIDindex;
